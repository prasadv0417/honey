...
const MOCK_PRODUCTS = [
  {
    ...
    description: '100% pure raw honey sourced from deep forest flora. Rich in antioxidants and natural enzymes.',
    price: 499,
    category: 'Raw Honey',
  ...
  },
  {
    ...
    description: 'Delicate and sweet honey from seasonal wildflowers. Perfect for your daily tea or toast.',
    price: 399,
    category: 'Wildflower',
    images: ['https://images.unsplash.com/photo-1471943311424-646960bdbcca?auto=format&fit=crop&q=80&w=800'],
  },
  {
    _id: '3',
    name: 'Eucalyptus Honey',
    description: 'Distinctive flavor with a hint of menthol. known for its respiratory health benefits.',
    price: 549,
    category: 'Medicinal',
    images: ['https://images.unsplash.com/photo-1557007559-0091494fd95c?auto=format&fit=crop&q=80&w=800'],
  }
];
      ...
      <section className="relative overflow-hidden pt-20 pb-24 md:pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold text-brown-950 mb-6 drop-shadow-sm leading-tight">
            ...
            <p className="text-xl text-brown-700 mb-10 leading-relaxed font-light">
              Experience the rich, authentic taste of raw honey straight from the hive to your table. Unfiltered, unpasteurized, and full of natural goodness.
            </p>
